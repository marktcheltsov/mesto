...
document.addEventListener('keydown', function (event) {
 if (event.keyCode == 27 && popupProfile.classList.contains('popup_opened')) {
    popupOpen(popupProfile);
    };
});

document.addEventListener('keydown', function (event) {
  if (event.keyCode == 27 && popupImage.classList.contains('popup_opened')) {
     popupOpen(popupImage);
     };
 });

document.addEventListener('keydown', function (event) {
 if (event.keyCode == 27 && popupCard.classList.contains('popup_opened')) {
    popupOpen(popupCard);
    };
});
